      ...
      items: [
        {
          ...
          image: { src: "/images/styles/contemporary.svg", alt: "Contemporary dance class" },
        },
        {
          ...
          image: { src: "/images/styles/chinese-dance.svg", alt: "Chinese dance class" },
        },
        {
          id: "style-tango",
          name: "Tango",
          slug: "tango",
          href: "/classes/tango",
          image: { src: "/images/styles/tango.svg", alt: "Tango class" },
        },
        {
          id: "style-yoga",
          name: "Yoga",
          slug: "yoga",
          href: "/classes/yoga",
          image: { src: "/images/styles/yoga.svg", alt: "Yoga class" },
        },
        {
          id: "style-tai-chi",
          name: "Tai Chi",
          ...
          image: { src: "/images/styles/tai-chi.svg", alt: "Tai Chi class" },
        },
  ...
  pages: {
    ...
    about: {
      ...
      hero: {
        ...
        title: "About CHD PAS",
        subtitle:
          "A London performing arts school where heritage meets forward-thinking training.",
        image: { src: "/images/about/teaser.svg", alt: "County Hall Dance studio" },
      } satisfies PageHeroContent,
      story: {
        title: "Our story",
        paragraphs: [
          "County Hall Dance & Performing Arts School was founded with a simple conviction: exceptional training and genuine care belong together.",
          "From our studios beside the Thames, we serve a diverse community of recreational dancers, ambitious teens, and adult learners rediscovering movement.",
          "Our faculty brings professional stage and studio experience, united by a shared commitment to safe, inspiring practice.",
        ],
      },
      values: {
        ...
        title: "Our values",
        items: [
          { title: "Excellence with warmth", description: "High standards delivered with patience and encouragement." },
          { title: "Inclusive community", description: "Every body, background, and aspiration is welcome." },
          { title: "Artistic integrity", description: "Training rooted in respected methods and creative exploration." },
        ...
        members: [
          {
            ...
            role: "Principal & Ballet",
            bio: "Former soloist with a major UK company; RAD registered teacher with twenty years of studio leadership.",
            image: { src: "/images/faculty/eleanor.svg", alt: "Eleanor Whitfield" },
          },
          {
            id: "faculty-2",
            name: "Marcus Okonkwo",
            role: "Contemporary & Choreography",
            bio: "Independent choreographer whose work has toured nationally; passionate about nurturing young creatives.",
            image: { src: "/images/faculty/marcus.svg", alt: "Marcus Okonkwo" },
          },
          {
            id: "faculty-3",
            name: "Sophie Laurent",
            role: "Musical Theatre",
            bio: "West End performer and vocal coach, specialising in triple-threat training for teens.",
            image: { src: "/images/faculty/sophie.svg", alt: "Sophie Laurent" },
          },
